...
\input{sections/02_genetic_architecture}
\input{sections/03_quantitative_genetics}
\input{sections/04_screening_theory}
\input{sections/05_breeding_programs}
\input{sections/06_inbreeding}
\input{sections/07_reintroduction}
\input{sections/08_pycnopodia_biology}
\input{sections/09_analysis_plan}
