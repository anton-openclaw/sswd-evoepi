...
The factor $\alpha_\ell^2/16$ arises from the mean-of-alleles encoding: 
$x_\ell = \alpha_\ell(a_1+a_2)/2$, so the allele substitution effect is 
$\alpha_\ell/2$, and segregation at a heterozygous locus contributes 
$(\alpha_\ell/2)^2 \times 1/4 = \alpha_\ell^2/16$ per parent. 
This was confirmed by simulation validation (\Cref{sec:validation}).
