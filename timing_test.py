"""Timing comparison script for spawning vectorization.

Tests performance of spawning system before and after vectorization.
"""
...
if __name__ == "__main__":
    print("BEFORE VECTORIZATION - Timing Test")
