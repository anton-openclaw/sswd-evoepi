...
\begin{description}
  ...
  \item[Recovery fractions:] Fractional population recovery at each region by
    2024, based on the best available survey data \citep{gravem2021, gehman2025}.
    Targets span four orders of magnitude: 50\% for Prince William Sound
    (substantial cold-water recovery) down to 0.1\% for northern California
    (near-extirpation in warm water).
\end{description}
