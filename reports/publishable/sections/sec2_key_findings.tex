...
highest fraction of its peak population at 9.4\% (5-year time-averaged), 
followed by northern British Columbia (BC-N) at 7.4\% and central California (CA-C) 
at 6.8\%. Oregon, despite showing episodic peaks up to 17.6\%, averages only 
5.4\% over the final five years due to extreme boom-bust volatility (CV=121\%). 
Alaska's Prince William Sound (AK-PWS) shows the most stable recovery at 2.5\% 
(CV=6\%), while outer Washington coast (WA-O) averages 4.9\%.
