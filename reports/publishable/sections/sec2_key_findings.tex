...
(Figure~\ref{fig:climate_effect}). In Alaska, the Frederick Sound region
...
mean host resistance rises from 0.15 to 0.43 by 2050---more than tripling. Oregon
follows at 0.36, reflecting strong but somewhat less intense selection. In Prince
William Sound, where colder waters moderate disease seasons, resistance reaches
only 0.26. And in southern California, the trajectory is truncated entirely:
...
resistance (0.36), while the pathogen, constrained by cooler waters that limit
...
percentage points (from 17.6\% to 12.8\%). Northern California similarly
loses 0.9 points. This paradox arises because pathogen evolution is not
...
\begin{enumerate}
    ...
    California show recovery rates three to four times the coastwide
