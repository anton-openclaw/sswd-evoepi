...
interrupt the long-term decline.  In the model, these pulses arise when
a sequence of cooler-than-average months suppresses pathogen activity
long enough for surviving adults to reproduce and juveniles to recruit
into the population.  The pulses are inherently self-limiting in the
simulation: the temporary increase in host density raises the effective
contact rate, and the subsequent return to warmer conditions triggers
renewed epizootic mortality that rapidly erases the demographic gain.
We note that these dynamics are emergent model predictions rather than
empirically documented phenomena---no field study has yet tracked
\textit{Pycnopodia} recruitment at the temporal resolution needed to
confirm or refute these pulse dynamics.
