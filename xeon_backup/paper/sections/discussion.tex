...
progressive outplanting trials from 2023 caged experiments through the
first uncaged release in 2024 \citep{kuow2024seastar} to the December
2025 California outplanting \citep{ssl2025outplanting},
provides the demographic foundation for such intervention.

\subsubsection{Breeding Target: Resistance over Recovery}

Under the biologically correct R$\to$S formulation (Section~\ref{sec:val_rs}),
the recovery trait ($c_i$) no longer evolves substantially because recovered
individuals return to the susceptible pool and face reinfection. Instead,
resistance ($r_i$) becomes the dominant adaptive response, with surviving
nodes showing 5.5$\times$ stronger resistance selection under R$\to$S
compared to permanent immunity. This shifts the recommended breeding
strategy from selecting for pathogen clearance to selecting for infection
prevention. Challenge experiments in captive facilities could identify
high-resistance individuals for preferential breeding. The \pyc{} reference
genome \citep{Schiebelhut2024genome} enables genome-wide association
studies to identify resistance loci. A combined strategy---selecting for
both high $r_i$ (avoiding infection) and moderate $c_i$ (surviving
breakthrough infections)---may be optimal.
...
\end{itemize}
Outplanting data from the 2024 San Juan Islands release \citep{kuow2024seastar}
and the December 2025 Monterey outplanting \citep{ssl2025outplanting}
will provide empirical validation targets for
