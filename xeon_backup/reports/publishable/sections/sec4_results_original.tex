...
\subsubsection{Pacific Northwest: Oregon's Dominance}

The Pacific Northwest cluster reveals the most striking regional
pattern in the entire forecast ensemble.  Oregon (OR) is the
unambiguous recovery leader under the baseline scenario, retaining
17.6\% of its initial population---more than three times the coast-wide
average and nearly double the next-best region (CA-C at 11.9\%).
Oregon's advantage derives from a combination of factors: strong
upwelling that maintains relatively cool summer SSTs, high initial
population density that buffers against stochastic extinction, and
sufficient thermal variability to provide seasonal windows of low
pathogen activity.

However, Oregon is also the region most vulnerable to both warming and
evolutionary change.  Under F04 (high warming), Oregon's recovery drops
to 10.4\%---a loss of 7.2 percentage points, the largest negative
climate effect of any region.  Under F02 (no evolution), Oregon
declines to 12.8\%, losing 4.8 points despite the coast-wide benefit
of freezing pathogen evolution.  These paradoxical vulnerabilities are
analyzed in Sections~\ref{sec:climate_effects} and
\ref{sec:pathogen_evo}.
