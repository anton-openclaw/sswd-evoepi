...
% Include interactions analysis first
\input{00_interactions_analysis}

% Include all section files
\input{01_disease_progression}
\input{02_pathogen_shedding}
\input{03_environmental_pathogen}
\input{04_recovery_immunity}
\input{05_growth_lifehistory}
\input{06_fecundity_recruitment}
\input{07_genetics}
\input{08_spawning_timing}
\input{09_spawning_induction}
\input{10_larval_dispersal}
\input{11_pathogen_evolution}
