#!/bin/bash
# Launch W135-W144 calibration: continuous alpha_self from enclosedness
# Tests larval retention in enclosed waterways
...
mkdir -p "${RESULTS_BASE}/W135-W144"
MAX_PARALLEL=24
RUNNING=0

for W in $(seq 135 144); do
    ...
    for SEED in 42 123 999; do
        ...
        LOGFILE="${RESULTS_BASE}/W135-W144/W${W}_seed${SEED}.log"
...
echo "Logs: ${RESULTS_BASE}/W135-W144/"
